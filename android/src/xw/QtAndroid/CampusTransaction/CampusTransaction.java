package xw.QtAndroid.CampusTransaction;
...
public class CampusTransaction extends QtActivity
{
    ...
    private static CampusTransaction m_instance;

    public CampusTransaction()
    {
        m_instance = this;
    }
...
/**
    ...
    // Create the File where the photo should go
        ...
        // Error occurred while creating the File
            Toast.makeText(CampusTransaction.this, ex.getLocalizedMessage(), Toast.LENGTH_LONG).show();
            Toast.makeText(CampusTransaction.this, ex.getMessage(), Toast.LENGTH_LONG).show();
        }
    ...
    {
        Toast.makeText(CampusTransaction.this, "Problems with your camera?!", Toast.LENGTH_SHORT).show();
    }
 }
